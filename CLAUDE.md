...
**HTML 网页项目（`03-projects/` 下新建）**：
1. 用户给出一句话需求后，先产出 `spec.md`（模板参考 `03-projects/韩语学习网站/spec.md`，包含目标、功能清单、数据结构、UI 布局、技术选择五个部分），用户确认后再写代码
2. spec.md 随项目迭代同步更新
3. 项目完成或达到里程碑后，生成 `项目笔记.md`（Obsidian 笔记格式，含 date/type/tags frontmatter，一句话描述，链接到 wiki outputs，访问方式，关键文件清单）
